package net.cumba.datatable.provider.sas.testsupport;
 ...
 * <p>
 * The classes in this module declare their loggers as
 ...
 * <p>
 * Copied verbatim (package renamed only) from {@code cumba-datatable-provider-rds}'s
 * {@code net.cumba.datatable.provider.rds.testsupport.LoggerCapture} — itself copied from
 * {@code cumba-datatable-impl}'s {@code net.cumba.datatable.impl.testsupport.LoggerCapture}
 * (test-scoped, not published as a test-jar, so not reusable across modules) rather than depended
 * on — the same convention {@code cumba-datatable-provider-xlsx} already follows.
 *
 * <pre>
...
public final class LoggerCapture implements AutoCloseable
{
     ...
     *
     * @param aLoggerName
     *            the logger name, which is the fully qualified class name of the logging class.
